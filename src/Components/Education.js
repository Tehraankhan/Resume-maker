                ...
                {item.map((elem, id) => {
                    if (elem.id != '1' && elem.name == "education") {
                        return (<>
                            ...
                            <div className="mt-[7px] w-[600px] h-[60px] border-[1px] border-solid  bg-[white]   shadow-sm" style={{ height: elem.heigh ? '600px' : '' }}>
                                ...
                                {elem.heigh &&
                                    ...
                                    <div className="flex flex-col mt-[-20px]">
                                        ...
                                        <input id={elem.id} name="type of eduaction" className=" w-[520px] h-[50px] border-[1px] mx-[auto] mt-[40px] border-solid ml-[43px]  px-[8px]  border-[#000000]" placeholder="Type of Education eg.collage" onChange={Input} value={elem.typeofeducation}></input>
                                        <input id={elem.id} name="institute name" className=" w-[520px] h-[50px] border-[1px] mx-[auto] mt-[20px] border-solid   ml-[43px]   px-[8px]  border-[#000000]" placeholder="institute name " onChange={Input} value={elem.institutename}></input>
                                        <input id={elem.id} name="degree" className=" w-[520px] h-[50px] border-[1px] mx-[auto] mt-[20px] border-solid ml-[43px]  px-[8px]  border-[#000000]" placeholder="degree" onChange={Input} value={elem.degree}></input>
                                        <input id={elem.id} name="year of graduation" className=" w-[520px] h-[50px] border-[1px] mx-[auto] mt-[20px] border-solid ml-[43px]  px-[8px]   border-[#000000]" placeholder="year of graduation" onChange={Input} value={elem.yearofgraduation}></input>
